...
from .connection import Connection, ConnectionParams, CursorFactory, DuckdbConnectionError
from ..base import (
    Adapter,
    BaseStats,
    ColumnMeta,
...
class DuckdbAdapter(Adapter):
    ...
    def estimate_row_count(self, fqn: str) -> int | None:
        return row_count_or_none(introspect_module.row_count_estimate(self._cursor, fqn))
